...
export default function SlowLivingPost() {
  return (
    <main className="max-w-3xl mx-auto px-6 py-24">
      ...
      {/* 1 */}
      <img src="/blog1.jpg" className="w-full rounded-lg mb-10" />

      <h2 className="text-2xl font-serif text-black mb-4">
        1️⃣ Warm Neutral Color Palettes
      </h2>
      ...
      <p className="text-lg text-black mb-14">
        ...
        adds visual depth and comfort. Textures make the room feel lively and
        cozy while keeping the overall aesthetic elegant and minimal.
      </p>
